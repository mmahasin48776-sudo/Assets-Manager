// ==========================================
// SUPABASE COMPLETE DATABASE BOOTSTRAP SCHEMA
// ==========================================
export const SUPABASE_SQL_SCHEMA = `-- Force immediate schema cache reload in PostgREST (Supabase)
...
-- Ensure columns exist for pre-existing tables if any upgrade is needed
ALTER TABLE users ADD COLUMN IF NOT EXISTS name TEXT;
ALTER TABLE users ADD COLUMN IF NOT EXISTS position TEXT;
ALTER TABLE users ADD COLUMN IF NOT EXISTS email TEXT DEFAULT 'admin@homescontracting.com';
...
-- Force final reload of PostgREST schema cache
NOTIFY pgrst, 'reload schema';
`;
